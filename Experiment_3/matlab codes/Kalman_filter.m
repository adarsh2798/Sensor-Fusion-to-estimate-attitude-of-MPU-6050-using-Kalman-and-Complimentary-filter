...
Q=1*diag([0.000006092348396;0.000006092348396;0.000006092348396;
...
while i1<N
    ...
    for r=1:10 % each sample consists of 10 readings, hence we perform the estimation 10 times
        w=gyroReadings(r,:)';
       %%%%%%%%% prior estimation%%%%%%%%%%%%
       phi=zeros(9,9);
